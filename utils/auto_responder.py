...
отправляется ответ с редиректом на продвигаемый продукт.
"""
...
AUTO_REPLY_TEMPLATES = [
    "Привет! Я пользуюсь {link} — {desc}. Попробуй, мне нравится 👍",
    "Здравствуй! Рекомендую — я на {link}. {desc}.",
    "Привет! Спасибо за сообщение. Я сижу на {link}. Рекомендую!",
    "Хей! Рад сообщению. Рекомендую {link}, {desc}. Работает стабильно.",
    "Привет! Рекомендую {link} — {desc}. Сам пользуюсь.",
]
