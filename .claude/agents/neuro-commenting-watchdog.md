...
description: "[LEGACY Telegram runtime] Monitor and audit the historical NEURO COMMENTING Telegram runtime. Do not use as the default agent for SaaS sprint delivery unless the task is explicitly about the legacy runtime."
model: opus
color: red
memory: project
---
